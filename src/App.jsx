...
function App() {
  ...
  return (
    <>
      {/* Header */}
      <div className={`fixed top-0 left-0 w-full z-50 flex items-center justify-between px-4 md:px-8 lg:px-12 h-[70px] ${textColorClass}`}
        style={{ backgroundColor: 'rgba(0, 0, 0, 0.85)' }}>
        
        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold font-['Gemunu_Libre'] font-light">
          <a className="logo close cursor-pointer" onClick={(e) => handleNavigation(e, 'Home')}>
            Alícia Antunes
          </a>
        </h1>
          ...
          <ul className="flex gap-6">
            <li>
              <a
                ...
                className={`close cursor-pointer hover:opacity-100 hover:text-lg hover:underline hover:underline-offset-4 transition-all ${activeSection === 'AboutMe' ? 'text-lg text-white underline underline-offset-4' : 'opacity-50'}`}
              >
                Sobre mim
              </a>
            </li>
            <li>
              <a
                ...
                className={`close cursor-pointer hover:opacity-100 hover:text-lg hover:underline hover:underline-offset-4 transition-all ${activeSection === 'MyProjects' ? 'text-lg text-white underline underline-offset-4' : 'opacity-50'}`}>
                Projetos
              </a>
            </li>
            <li>
              <a
                ...
                className={`close cursor-pointer hover:opacity-100 hover:text-lg hover:underline hover:underline-offset-4 transition-all ${activeSection === 'MyKnowlege' ? 'text-lg text-white underline underline-offset-4' : 'opacity-50'}`}>
                Conhecimentos
              </a>
            </li>
            <li>
              <a
                ...
                className={`close cursor-pointer hover:opacity-100 hover:text-lg hover:underline hover:underline-offset-4 transition-all ${activeSection === 'ContactMe' ? 'text-lg text-white underline underline-offset-4' : 'opacity-50'}`}>
                Contato
              </a>
            </li>
          </ul>
        ...
        <div className="hidden lg:flex gap-4">
          <div className={`${iconColorClass} hover:text-purple-700 transition-colors`}>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed top-[70px] left-0 w-full bg-black bg-opacity-95 z-40 lg:hidden">
          <ul className="flex flex-col items-center py-6 gap-4">
            <li>
              <a
                onClick={(e) => handleNavigation(e, 'AboutMe')}
                className={`close cursor-pointer text-lg ${activeSection === 'AboutMe' ? 'text-purple-500 underline' : 'text-white'}`}
              >
                Sobre mim
              </a>
            </li>
            <li>
              <a
                onClick={(e) => handleNavigation(e, 'MyProjects')}
                className={`close cursor-pointer text-lg ${activeSection === 'MyProjects' ? 'text-purple-500 underline' : 'text-white'}`}>
                Projetos
              </a>
            </li>
            <li>
              <a
                onClick={(e) => handleNavigation(e, 'MyKnowlege')}
                className={`close cursor-pointer text-lg ${activeSection === 'MyKnowlege' ? 'text-purple-500 underline' : 'text-white'}`}>
                Conhecimento
              </a>
            </li>
            <li>
              <a
                onClick={(e) => handleNavigation(e, 'ContactMe')}
                className={`close cursor-pointer text-lg ${activeSection === 'ContactMe' ? 'text-purple-500 underline' : 'text-white'}`}>
                Contatos
              </a>
            </li>
            <li className="flex gap-6 mt-4">
              <a href="https://twitter.com/Alicia07antunes" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:text-purple-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/in/al%C3%ADcia-antunes-084849237/" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:text-purple-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.5c-.966 0-1.5-.783-1.5-1.5s.534-1.5 1.5-1.5 1.5 .783 1.5 1.5-.534 1.5-1.5 1.5zm12 11.5h-3v-5.5c0-1.379-.025-3.5-2.375-3.5-2.375 0-2.625 1.667-2.625 3.392v5.608h-3v-10h3v1.367h.042c.417-.791 1.433-1.367 2.958-1.367 3.167 0 3.75 2.083 3.75 4.792v5.208z" />
                </svg>
              </a>
              <a href="https://github.com/aliciaantunes" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:text-purple-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
                  <path d="M12 0.297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385 0.6 0.113 0.82-0.258 0.82-0.577 0-0.285-0.01-1.04-0.015-2.04-3.338 0.724-4.042-1.61-4.042-1.61-0.546-1.387-1.334-1.757-1.334-1.757-1.091-0.745 0.082-0.729 0.082-0.729 1.205 0.084 1.838 1.236 1.838 1.236 1.07 1.835 2.807 1.305 3.492 0.998 0.108-0.775 0.418-1.305 0.761-1.605-2.665-0.3-5.467-1.332-5.467-5.93 0-1.31 0.468-2.38 1.235-3.22-0.123-0.303-0.535-1.524 0.117-3.176 0 0 1.008-0.322 3.3 1.23 0.957-0.267 1.983-0.399 3.003-0.404 1.02 0.005 2.047 0.137 3.006 0.404 2.29-1.552 3.297-1.23 3.297-1.23 0.653 1.652 0.241 2.873 0.118 3.176 0.77 0.84 1.235 1.91 1.235 3.22 0 4.61-2.807 5.625-5.479 5.92 0.43 0.371 0.813 1.102 0.813 2.222 0 1.606-0.015 2.896-0.015 3.286 0 0.32 0.216 0.694 0.825 0.577 4.765-1.586 8.2-6.081 8.2-11.386 0-6.627-5.373-12-12-12z" />
                </svg>
              </a>
      ...
      <div>
        {/* Home Section */}
        <div id="Home" className="flex items-center justify-center min-h-screen bg-black text-white pt-[70px]">
          <div className="flex flex-col lg:flex-row justify-between items-center w-full px-4 md:px-8 lg:px-20 xl:px-40 2xl:px-80 gap-8 lg:gap-12 py-12">
            <div className="text-white flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl">
              <p className="text-purple-500 text-sm md:text-base mb-2">&lt;p&gt;Hello World&lt;/p&gt;</p>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4">Sou Alícia</h1>
              <p className="text-lg sm:text-xl md:text-2xl typing-effect mb-8 border border-solid inline-block px-2">Estudante de tecnologia em constante evolução.</p>
              <a 
                className="text-purple-500 border-2 border-purple-500 hover:bg-purple-500 hover:text-black px-8 py-3 transition-all cursor-pointer" 
                onClick={(e) => handleNavigation(e, 'ContactMe')}>
                Contate-me
              </a>
            </div>
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 bg-purple-500 flex items-center justify-center flex-shrink-0" 
              style={{ borderRadius: "20% 80% 30% 70% / 60% 40% 60% 40%", boxShadow: "10px 10px 20px rgba(0,0,0,0.2)" }}>
              <img src="/images/alicia_pic.png" alt="picture of me <3" className="mt-12 md:mt-16 max-w-full h-auto" />
            </div>
          </div>
        </div>

        {/* About Me Section */}
        <div id="AboutMe" className="flex items-center justify-center min-h-screen bg-[#121212] text-white py-20 px-4">
          <div className="flex flex-col lg:flex-row max-w-7xl w-full gap-8 lg:gap-12 items-center">
            <div className="flex justify-center items-center w-full lg:w-1/2">
              <img src="/images/foto_alicia_inteira.jpg" alt="picture of me <3" className="max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg object-contain rounded-3xl" />
            </div>
            <div className="flex flex-col justify-center w-full lg:w-1/2 space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl text-purple-500 mb-4">Sobre mim</h1>
              <p className="text-base sm:text-lg leading-relaxed">
               Sou desenvolvedora com experiência em JavaScript, utilizando principalmente React, Node.js, ES6+ e Redux para desenvolvimento de aplicações web. Ao longo da minha trajetória, também adquiri prática com Git e metodologias ágeis, o que me permite colaborar bem em equipe e me adaptar rapidamente a diferentes desafios.
              </p>
              <p className="text-base sm:text-lg leading-relaxed">
                Tenho grande interesse em consumo de APIs e integração de dados, área que sempre me chamou atenção por envolver a comunicação entre sistemas e a organização das informações dentro das aplicações. Essa curiosidade pelo comportamento e pela estrutura dos dados também despertou meu interesse pela área de análise de dados, onde venho expandindo meus conhecimentos em ferramentas como Excel e Power BI.
              </p>
              <p className="text-base sm:text-lg leading-relaxed">
                Atualmente busco oportunidades que me permitam continuar evoluindo como desenvolvedora, contribuindo para projetos reais e colaborando com equipes que valorizem aprendizado contínuo, troca de conhecimento e construção de soluções eficientes.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Projects Section */}
        <div id="MyProjects" className="bg-black text-white min-h-screen flex flex-col items-center justify-center py-20 px-4">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl text-purple-500 text-center mb-12">Projetos</h1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl w-full">

            <div className="group bg-[#121212] hover:bg-neutral-800 shadow-lg transition duration-300 ease-in-out w-full max-w-sm mx-auto flex flex-col items-center justify-center rounded-xl p-6 relative">
              <p className="mb-5 text-xl sm:text-2xl text-purple-500">My reads</p>
              <img src="/images/my-reads.gif" alt="gif" className='group-hover:opacity-50 transition duration-300 ease-in-out w-52 rounded-md mb-4' />

              <div className='flex flex-row gap-3 mb-4'>
              <a href="https://github.com/aliciaantunes/Udacity-My-Reads" target="_blank" rel="noopener noreferrer">
                <div className="group/icon flex w-14 h-14 sm:w-16 sm:h-16">
                ...
                <div className="group/eye flex w-14 h-14 sm:w-16 sm:h-16 mt-5">
              ...
              <div className="flex items-center justify-center px-4 text-center">
                <p className="text-sm sm:text-base">Aplicativo de acompanhamento de livros desenvolvido como projeto para a conclusão do curso da Udacity.</p>
              </div>
            </div>

            <div className="text-white group bg-[#121212] hover:bg-neutral-800 shadow-lg transition duration-300 ease-in-out w-full max-w-sm mx-auto flex flex-col items-center justify-center rounded-xl p-6">
              <p className="mb-5 text-xl sm:text-2xl text-purple-500">Poll-Pick</p>
              <img src="/images/employe-poll.gif" alt="gif" className='group-hover:opacity-50 transition duration-300 ease-in-out w-52 rounded-md mb-4' />
              <div className='flex flex-row gap-3 mb-4'>
              ...
              <div className="flex items-center justify-center px-4 text-center">
                <p className="text-sm sm:text-base">Aplicativo onde funcionários podem criar enquetes com duas opções de escolha. Desenvolvido como projeto final para conclusão do curso da Udacity.</p>
              </div>
            </div>

            <div className="text-white group bg-[#121212] hover:bg-neutral-800 shadow-lg transition duration-300 ease-in-out w-full max-w-sm mx-auto flex flex-col items-center justify-center rounded-xl p-6">
              <p className="mb-5 text-xl sm:text-2xl text-purple-500">Shopping cart</p>
              <img src="/images/my-cart.gif" alt="gif" className='group-hover:opacity-50 transition duration-300 ease-in-out w-52 rounded-md mb-4' />
              <div className='flex flex-row gap-3 mb-4'>
              ...
              <div className="flex items-center justify-center px-4 text-center">
                <p className="text-sm sm:text-base">Carrinho de compras desenvolvido como projeto para conclusão do curso da Udacity.</p>
              </div>
            </div>

            <div className="text-white group bg-[#121212] hover:bg-neutral-800 shadow-lg transition duration-300 ease-in-out w-full max-w-sm mx-auto flex flex-col items-center justify-center rounded-xl p-6">
              <p className="mb-5 text-xl sm:text-2xl text-purple-500">Este portifólio</p>
              <img src="/images/my-portfolio.gif" alt="gif" className='group-hover:opacity-50 transition duration-300 ease-in-out w-52 rounded-md mb-4' />
              <div className='flex flex-row gap-3 mb-4'>
              ...
              <div className="flex items-center justify-center px-4 text-center">
                <p className="text-sm sm:text-base">Meu portfólio pessoal, onde você pode explorar meus projetos, habilidades e trajetória profissional com mais detalhes.</p>
              </div>
            </div>
        ...
        {/* Knowledge Section */}
        <div id="MyKnowlege" className="flex flex-col items-center justify-center min-h-screen text-white bg-[#121212] py-20 px-4">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl text-purple-500 text-center mb-12">Conhecimentos</h1>

          <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 sm:gap-6 max-w-7xl w-full'>

            <div className='bg-zinc-950 hover:scale-110 transition duration-300 ease-in-out w-full aspect-[3/4] flex items-center justify-center flex-col rounded-xl p-4'>
        ...
        {/* Contact Section */}
        <div id="ContactMe" className="flex items-center justify-center min-h-screen bg-black text-white py-20 px-4">
          <div className="flex flex-col items-center justify-center w-full max-w-2xl space-y-6">

            <img src="/images/qr-code.png" alt="MyWhatsapp" className='hover:scale-110 rounded-lg w-32 sm:w-40 mb-6' />

            <h1 className="text-3xl sm:text-4xl lg:text-5xl text-purple-500 text-center mb-6">Contate-me</h1>
            ...
            <div className="flex items-center flex-wrap justify-center gap-2">
              ...
              <p>+55 (13) 99122-7010</p>
            </div>
            <a className="group text-purple-500 border-2 border-purple-500 hover:bg-purple-500 hover:text-black flex items-center gap-2 px-8 py-3 mt-6 transition-all" href="https://wa.me/5513991227010" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="icon-whatsapp text-purple-500 group-hover:text-black">
