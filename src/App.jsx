      ...
      <div>
        ...
        <div id="AboutMe" className="flex items-center justify-center h-screen" style={{ backgroundColor: '#121212', color: 'white', width: '1520px', height: '720px' }}>
          ...
          <div className="text-white" style={{ width: '700px', height: '80px', marginLeft: '-200px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ fontSize: '18px', marginBottom: '20px', marginTop:"30px" }}>
Since I was 18, I have been working as a developer, and over the years, I have gained extensive experience with a variety of technologies. My primary tools include React, Node.js, ES6+, and Redux for state management. Additionally, I am proficient in git and agile methodologies, enabling me to collaborate effectively in teams and adapt quickly to new challenges.</p>
  ...
  <p style={{ fontSize: '18px', marginBottom: '20px' }}>I&apos;m passionate about development and truly believe in the power of collaboration. Communication is one of my greatest strengths, and I love working in teams to create amazing solutions. I believe that exchanging ideas and diversity of perspectives are fundamental to the success of any project.</p>
        ...
        <div id="ContactMe" className="flex items-center justify-center h-screen bg-black text-white w-full h-720 flex">
          <div className="flex flex-col items-center justify-center w-full h-full" >
            ...
            <img src="/images/qr-code.png" alt="MyWhatsapp" className='hover:scale-110 rounded-lg' style={{ width: '150px', marginBottom: "30px" }} />
            ...
            <a className="group text-purple-500 border-2 border-purple-500 border solid hover:bg-purple-500 hover:text-black flex items-center" style={{ marginTop: "20px", paddingRight: "30px", paddingLeft: "35px", paddingTop: "10px", paddingBottom: "10px" }} href="https://wa.me/5513991227010">
