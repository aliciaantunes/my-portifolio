...
function App() {
  ...
  <a className="text-purple-500 border-2 border-purple-500 border solid hover:bg-purple-500 hover:text-black" style={{ marginTop: "20px", paddingRight: "30px", paddingLeft: "35px", paddingTop: "10px", paddingBottom: "10px" }} href="#ContactMe">Talk to me</a>
    ...
    <div className="relative w-96 h-96 bg-purple-500 flex items-center justify-center" style={{ borderRadius: "20% 80% 30% 70% / 60% 40% 60% 40%", boxShadow: "10px 10px 20px rgba(0,0,0,0.2)", marginRight:"100px" }}>
...
<div id="MyProjects" className="bg-black text-white w-1700 h-720 flex items-center justify-center h-full" style={{display: 'flex', flexDirection: 'column'}}>
  ...
  <div className="text-white group bg-[#121212] hover:bg-neutral-800 shadow-lg transition duration-300 ease-in-out relative" style={{ width: '300px', height: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: '10px', margin: '30px' }}>
  <p style={{ marginBottom: '20px' }}>My reads</p>
  <div className="relative">
    <img src="/images/giphy.gif" alt="gif" className='transition duration-300 ease-in-out' style={{ width: '130px' }}/>
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100" viewBox="0 0 24 24">
      <path d="M12 0.297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385 0.6 0.113 0.82-0.258 0.82-0.577 0-0.285-0.01-1.04-0.015-2.04-3.338 0.724-4.042-1.61-4.042-1.61-0.546-1.387-1.334-1.757-1.334-1.757-1.091-0.745 0.082-0.729 0.082-0.729 1.205 0.084 1.838 1.236 1.838 1.236 1.07 1.835 2.807 1.305 3.492 0.998 0.108-0.775 0.418-1.305 0.761-1.605-2.665-0.3-5.467-1.332-5.467-5.93 0-1.31 0.468-2.38 1.235-3.22-0.123-0.303-0.535-1.524 0.117-3.176 0 0 1.008-0.322 3.3 1.23 0.957-0.267 1.983-0.399 3.003-0.404 1.02 0.005 2.047 0.137 3.006 0.404 2.29-1.552 3.297-1.23 3.297-1.23 0.653 1.652 0.241 2.873 0.118 3.176 0.77 0.84 1.235 1.91 1.235 3.22 0 4.61-2.807 5.625-5.479 5.92 0.43 0.371 0.813 1.102 0.813 2.222 0 1.606-0.015 2.896-0.015 3.286 0 0.32 0.216 0.694 0.825 0.577 4.765-1.586 8.2-6.081 8.2-11.386 0-6.627-5.373-12-12-12z"/>
    </svg>
  </div>
  ...
  <div id="MyKnowlege" className="flex flex-col items-center justify-center h-screen text-white w-1700 h-720" style={{backgroundColor: '#121212'}}>
      <div> 
        <h1 className="text-5xl text-purple-500 text-center" style={{marginTop: "5px", marginBottom:"20px", marginLeft:"20px", marginRight:"170px"}}>Knowlege</h1>
       </div>
      
       <div className='grid grid-cols-6 gap-4' style={{marginRight:"170px"}}>
  ...
  <div className="flex flex-col items-center justify-center w-full h-full" style={{ marginRight: '700px' }}>
